...
import br.dev.ibs.springbatch1.dominio.Transacao;
...
@Configuration
public class LeituraArquivoMultiplosFormatosLineMapperConfig {
	
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Bean
	public LineMapper leituraArquivoMultiplosFormatosLineMapper() {
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	private FieldSetMapper fieldSetMapper(final Class classe) {
